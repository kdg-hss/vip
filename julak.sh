...
# // Banner
echo -e "${YELLOW}----------------------------------------------------------${NC}"
echo -e "  Welcome To Julak VPN Tunneling ${YELLOW}(${NC}${green} Stable Edition ${NC}${YELLOW})${NC}"
echo -e " This Will Quick Setup VPN Server On Your Server"
echo -e "  Author : ${green}╭────────────Julak_Bantur®────────────╮${NC}${YELLOW}(${NC} ${green} Julak VPN Tunneling ${NC}${YELLOW})${NC}"
echo -e " © Recode By Julak Bantur${YELLOW}(${NC} 2025 ${YELLOW})${NC}"
echo -e "${YELLOW}----------------------------------------------------------${NC}"
echo ""
sleep 2
###### IZIN SC 
...
chmod +x /etc/pam.d/common-password
    ...
    debconf-set-selections <<<"keyboard-configuration keyboard-configurat
